...
export default function BlogPage() {
  const title = "Top 10 Payment Gateway Trends in India (2025) | Ztake";
          const description = "In-depth article: Top 10 Payment Gateway Trends in India (2025)";
  const canonical = "https://pay.ztake.in/blog/02-top-10-payment-gateway-trends-in-india-(2025)";
  const ogImage = "/api/og?title=Top+10+Payment+Gateway+Trends+in+India+%282025%29+%7C+Ztake";
...
Top 10 Payment Gateway Trends in India (2025) — this article dives deep into the topic, explains why it matters in 2025, and provides practical steps for businesses.
