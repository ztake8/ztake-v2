...
export default function BlogPage() {
  const title = "Best Payment Gateway for Small Businesses in India | Ztake";
          const description = "In-depth article: Best Payment Gateway for Small Businesses in India";
  const canonical = "https://pay.ztake.in/blog/05-best-payment-gateway-for-small-businesses-in-india";
  const ogImage = "/api/og?title=Best+Payment+Gateway+for+Small+Businesses+in+India+%7C+Ztake";
  ...
  return (
    <>
      ...
      <main style={{maxWidth:900,margin:'40px auto',fontFamily:'system-ui'}}>
        <article>
# Best Payment Gateway for Small Businesses in India

Best Payment Gateway for Small Businesses in India — this article dives deep into the topic, explains why it matters in 2025, and provides practical steps for businesses.
