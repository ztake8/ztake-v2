...
export default function BlogPage() {
  const title = "The Ultimate Guide to Vendor & Supplier Payout Automation | Ztake";
          const description = "In-depth article: The Ultimate Guide to Vendor & Supplier Payout Automation";
  const canonical = "https://pay.ztake.in/blog/14-the-ultimate-guide-to-vendor-&-supplier-payout-automation";
  const ogImage = "/api/og?title=The+Ultimate+Guide+to+Vendor+%26+Supplier+Payout+Automation+%7C+Ztake";
  ...
  return (
    <>
      ...
      <main style={{maxWidth:900,margin:'40px auto',fontFamily:'system-ui'}}>
        <article>
# The Ultimate Guide to Vendor & Supplier Payout Automation

The Ultimate Guide to Vendor & Supplier Payout Automation — this article dives deep into the topic, explains why it matters in 2025, and provides practical steps for businesses.
